...
class HttpSession(requests.Session):
    ...
    def request(self, method, url, name=None, **kwargs):
        ...
        self.meta_data["request"]["url"] = response.url
        # self.meta_data["request"]["headers"] = dict(response.request.headers)
        self.meta_data["request"]["headers"] = dict(response.headers)
        ...
        self.meta_data["response"]["client_ip"] = response.client_ip
        ...
        self.meta_data["response"]["stats"] = response.stats
